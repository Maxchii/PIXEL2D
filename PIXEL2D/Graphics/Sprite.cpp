...
namespace PIXL{ namespace graphics{
	...
	Sprite::Sprite(Texture& texture, const math::Vector4& color /*= math::Vector4(1.0f,1.0f,1.0f,1.0f)*/)
	{
		m_texture = &texture;
	...
	Sprite::Sprite(Texture& texture, const math::Rectangle& sourceRect, const math::Vector4& color /*= math::Vector4(1.0f, 1.0f, 1.0f, 1.0f)*/)
	{
		m_texture = &texture;

		std::array<math::Vector2, 4> uvCords;
	...
	Sprite::Sprite(Texture& texture, const math::Rectangle& sourceRect, const math::Vector2& size, const math::Vector4& color /*= math::Vector4(1.0f, 1.0f, 1.0f, 1.0f)*/)
	{
		m_texture = &texture;
